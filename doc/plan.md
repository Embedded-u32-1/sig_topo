...
当前阶段：**v0.12 全收口（M31–M33 ✅，160 测试绿，0.2.0）。空闲决策点后，经判断启动 v0.13 新方向：DDL 表达力补全。M34 起由 agent 逐步实现。**
...
- 当前：M31 ✅ M32 ✅ M33 ✅；v0.12 全收口。下一步方向待判断。
...
- 全模块 doc-comments 复核（M34 触及的 parser/codegen）。
- version 0.2.0 → 0.3.0。
