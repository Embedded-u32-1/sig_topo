...
v0.14（M38 reaction guard 复合语义 + M39 guard demo + stc --check 增强 + M40 收口）全收口，195 测试绿，version 0.4.0。候选后续方向（暂不排期，待下一步指令）：
